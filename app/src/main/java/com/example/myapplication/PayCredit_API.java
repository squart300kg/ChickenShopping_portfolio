...
public class PayCredit_API extends AppCompatActivity {

    WebView webview_paycart;
    String url = "https://www.iamport.kr/demo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_credit__api);
