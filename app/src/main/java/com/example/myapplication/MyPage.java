...
import static com.example.myapplication.UserInfo.buyList;

public class MyPage extends AppCompatActivity {
    static Activity myPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myPage = MyPage.this;//추후에 이 페이지를 종료시켜주기 위해 초기화함
    ...
    public void changeUserInfo(View view) {
        Intent intent = new Intent(this, ChangeUserInfo.class);
